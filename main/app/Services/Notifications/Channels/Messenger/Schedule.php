...
class Schedule
{
    ...
    /**
     * Отправка сообщений по расписанию: выборка пачки, удаление из
     * очереди, отправка. Ответ сендера решает судьбу сообщения:
     * блокировка бота — отписка, временный сбой — возврат в очередь.
     */
